...
## Goal
Create login and signup pages with Supabase authentication.
...
### 1. apps/dashboard/app/(auth)/layout.tsx
```tsx
...
### 2. apps/dashboard/app/(auth)/login/page.tsx
```tsx
'use client'
...
export default function LoginPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold">Sign in to PulseChat</h1>
...
### 3. apps/dashboard/app/(auth)/signup/page.tsx
```tsx
'use client'
